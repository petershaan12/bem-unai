...
const CardBerita: React.FC<CardProps> = ({
  title,
  date,
  bannerImage,
  organizer,
  ...
  return (
    <div className="flex flex-col p-6 gap-10 border h-full rounded-xl border-white/40 hover:bg-black/40 ">
      <Image
      ...
      />
      <div>
        <h3 className="text-white text-4xl font-bigNoddle">{title}</h3>
